...
const PROPERTY_DATA: Record<string, PropertyData> = {
  'nitta-102': {
    name: 'Nitta 102',
    sections: [
      { icon: '📍', title: { es: 'Ubicación', en: 'Location', fr: 'Emplacement' }, content: { es: 'Paseo de los Cocoteros 111, Nuevo Vallarta, Nay.\nDepartamento 102\n\n📍 Google Maps:\nhttps://share.google/ydWVSS7bXzxgeMA2n', en: 'Paseo de los Cocoteros 111, Nuevo Vallarta, Nay.\nApartment 102\n\n📍 Google Maps:\nhttps://share.google/ydWVSS7bXzxgeMA2n', fr: 'Paseo de los Cocoteros 111, Nuevo Vallarta, Nay.\nAppartement 102\n\n📍 Google Maps:\nhttps://share.google/ydWVSS7bXzxgeMA2n' } },
      { icon: '🔐', title: { es: 'Acceso al Edificio', en: 'Building Access', fr: 'Accès au Bâtiment' }, content: { es: '1. Regístrate en la caseta de seguridad antes de entrar\n2. Ve al lado DERECHO del edificio\n3. Entras en PB (planta baja) — sube al Piso 1\n\n⚠️ No hay recepción.', en: '1. Stop by security booth to register before entering\n2. Go to the RIGHT side of the building\n3. You enter on PB (ground floor) — go up to Floor 1\n\n⚠️ There is no front desk.', fr: '1. Enregistrez-vous à la guérite de sécurité avant d\'entrer\n2. Allez du côté DROIT du bâtiment\n3. Vous entrez au PB (rez-de-chaussée) — montez au 1er étage\n\n⚠️ Il n\'y a pas de réception.' } },
      { icon: '🚪', title: { es: 'Acceso al Departamento', en: 'Apartment Access', fr: 'Accès à l\'Appartement' }, content: { es: 'Departamento: 102\nCódigo de puerta: 1950\nCódigo acceso playa: 1412\n\n⚠️ No compartas los códigos con personas fuera de tu grupo.\n⚠️ No dejes el seguro puesto al salir (bloquea códigos y tarjetas).', en: 'Apartment: 102\nDoor code: 1950\nBeach access code: 1412\n\n⚠️ Don\'t share codes with anyone outside your group.\n⚠️ Don\'t leave the deadbolt engaged when leaving (blocks codes and cards).', fr: 'Appartement: 102\nCode de porte: 1950\nCode d\'accès plage: 1412\n\n⚠️ Ne partagez pas les codes avec des personnes hors de votre groupe.\n⚠️ Ne laissez pas le verrou engagé en partant (bloque les codes et cartes).' } },
      { icon: '📶', title: { es: 'WiFi', en: 'WiFi', fr: 'WiFi' }, content: { es: 'Los datos del WiFi están dentro del departamento.\nBusca las etiquetas con red y contraseña.', en: 'WiFi details are inside the apartment.\nLook for labels with network and password.', fr: 'Les détails WiFi sont dans l\'appartement.\nCherchez les étiquettes avec réseau et mot de passe.' } },
      { icon: '🅿️', title: { es: 'Estacionamiento', en: 'Parking', fr: 'Stationnement' }, content: { es: 'Solicita acceso con anticipación.', en: 'Request access in advance.', fr: 'Demandez l\'accès à l\'avance.' } },
  ...
  'avida-408': {
    name: 'Avida Residences 408',
    sections: [
      { icon: '📍', title: { es: 'Ubicación', en: 'Location', fr: 'Emplacement' }, content: { es: 'Insurgentes 189, Zona Romántica\nEmiliano Zapata, 48380 Puerto Vallarta, Jal.\n\n📍 Google Maps:\nhttps://maps.app.goo.gl/vW19zAMdhstP4c146', en: 'Insurgentes 189, Romantic Zone\nEmiliano Zapata, 48380 Puerto Vallarta, Jal.\n\n📍 Google Maps:\nhttps://maps.app.goo.gl/vW19zAMdhstP4c146', fr: 'Insurgentes 189, Zone Romantique\nEmiliano Zapata, 48380 Puerto Vallarta, Jal.\n\n📍 Google Maps:\nhttps://maps.app.goo.gl/vW19zAMdhstP4c146' } },
      { icon: '🔐', title: { es: 'Acceso al Edificio', en: 'Building Access', fr: 'Accès au Bâtiment' }, content: { es: '🚪 Entrada por Francisco I. Madero\n\nAl llegar:\n1. Ve al escritorio de seguridad (planta baja)\n2. Te pedirán identificación oficial\n3. Te darán reglas del edificio para firmar\n4. Recibirás un BRAZALETE — úsalo siempre en la propiedad\n\n🛗 Elevador:\n• Requiere tarjeta de acceso\n• Seguridad te ayudará a subir al Piso 4', en: '🚪 Entrance on Francisco I. Madero\n\nUpon arrival:\n1. Go to security desk (ground level)\n2. They\'ll ask for valid ID\n3. You\'ll receive building rules to sign\n4. You\'ll get a BRACELET — wear it at all times on property\n\n🛗 Elevator:\n• Key card required\n• Security will assist you to Floor 4', fr: '🚪 Entrée sur Francisco I. Madero\n\nÀ votre arrivée:\n1. Allez au bureau de sécurité (rez-de-chaussée)\n2. Ils demanderont une pièce d\'identité\n3. Vous recevrez les règles du bâtiment à signer\n4. Vous recevrez un BRACELET — portez-le en tout temps\n\n🛗 Ascenseur:\n• Carte d\'accès requise\n• La sécurité vous aidera à monter au 4ème étage' } },
      { icon: '🚪', title: { es: 'Acceso al Departamento', en: 'Apartment Access', fr: 'Accès à l\'Appartement' }, content: { es: 'Departamento: 408\nCódigo de acceso: 445566 #\n\nDentro encontrarás:\n• 2 llaves azules (tokens) para la puerta\n• 2 tarjetas blancas para elevador y acceso nocturno al edificio\n\n⚠️ Conserva el brazalete y tarjetas contigo siempre.\n⚠️ Devuélvelos antes del check-out.\n⚠️ No compartas códigos con personas fuera de tu grupo.', en: 'Apartment: 408\nAccess code: 445566 #\n\nInside you\'ll find:\n• 2 blue keys (tokens) for the door\n• 2 white cards for elevator and after-hours building access\n\n⚠️ Keep bracelet and cards with you at all times.\n⚠️ Return them before check-out.\n⚠️ Don\'t share codes with anyone outside your group.', fr: 'Appartement: 408\nCode d\'accès: 445566 #\n\nÀ l\'intérieur vous trouverez:\n• 2 clés bleues (jetons) pour la porte\n• 2 cartes blanches pour l\'ascenseur et l\'accès au bâtiment après les heures\n\n⚠️ Gardez le bracelet et les cartes avec vous en tout temps.\n⚠️ Retournez-les avant le départ.\n⚠️ Ne partagez pas les codes avec des personnes hors de votre groupe.' } },
      { icon: '📶', title: { es: 'WiFi', en: 'WiFi', fr: 'WiFi' }, content: { es: 'Los datos del WiFi están dentro de la unidad.\n📍 Busca las etiquetas — el nombre de red empieza con INFINITUM', en: 'WiFi details are available inside the unit.\n📍 Look for labels — network name starts with INFINITUM', fr: 'Les détails WiFi sont dans l\'unité.\n📍 Cherchez les étiquettes — le nom du réseau commence par INFINITUM' } },
      { icon: '🅿️', title: { es: 'Estacionamiento', en: 'Parking', fr: 'Stationnement' }, content: { es: 'Cajón asignado: 408\n\nSolicita acceso con anticipación.\nSi llegas con más de un vehículo, avísanos antes.', en: 'Assigned spot: 408\n\nRequest access in advance.\nIf arriving with more than one vehicle, let us know beforehand.', fr: 'Place assignée: 408\n\nDemandez l\'accès à l\'avance.\nSi vous arrivez avec plus d\'un véhicule, prévenez-nous.' } },
      { icon: '🔒', title: { es: 'Caja Fuerte', en: 'Safe', fr: 'Coffre-fort' }, content: { es: 'Hay una caja fuerte para tus pertenencias.\n\n1. Sigue las instrucciones dentro de la caja\n2. Configura tu propio código\n3. ⚠️ Pruébalo al menos una vez ANTES de cerrar\n4. Al salir, deja la caja abierta y resetea el código', en: 'A safe is available for your belongings.\n\n1. Follow instructions inside the safe\n2. Set your own code\n3. ⚠️ Test it at least once BEFORE closing\n4. Before checkout, leave safe open and reset code', fr: 'Un coffre-fort est disponible.\n\n1. Suivez les instructions à l\'intérieur\n2. Définissez votre propre code\n3. ⚠️ Testez-le au moins une fois AVANT de fermer\n4. Avant le départ, laissez-le ouvert et réinitialisez le code' } },
      { icon: '🏠', title: { es: 'Reglas de la Casa', en: 'House Rules', fr: 'Règles de la Maison' }, content: { es: '• Quítate la arena antes de entrar\n• Apaga el A/C con puertas/ventanas abiertas\n• 🚭 No fumar adentro\n• Los controles están etiquetados en las paredes', en: '• Remove sand before entering\n• Turn off A/C when doors/windows are open\n• 🚭 No smoking inside\n• Remotes are labeled on the walls', fr: '• Enlevez le sable avant d\'entrer\n• Éteignez la clim si portes/fenêtres ouvertes\n• 🚭 Interdiction de fumer à l\'intérieur\n• Les télécommandes sont étiquetées sur les murs' } },
      { icon: '🚽', title: { es: 'Plomería (MUY IMPORTANTE)', en: 'Plumbing (VERY IMPORTANT)', fr: 'Plomberie (TRÈS IMPORTANT)' }, content: { es: '⚠️ NO arrojes al inodoro:\n• Papel higiénico\n• Toallitas\n• Productos femeninos\n• Toallas de papel\n• NINGÚN objeto\n\nPlomería mexicana muy sensible.\n💰 Cargo de $50 USD por taponamiento.\nUsa el bote de basura.', en: '⚠️ Do NOT flush:\n• Toilet paper\n• Wipes\n• Feminine products\n• Paper towels\n• ANY objects\n\nVery sensitive Mexican plumbing.\n💰 $50 USD charge for clogs.\nUse the trash bin provided.', fr: '⚠️ NE JETEZ PAS dans les toilettes:\n• Papier toilette\n• Lingettes\n• Produits féminins\n• Essuie-tout\n• AUCUN objet\n\nPlomberie mexicaine très sensible.\n💰 Frais de 50 USD en cas de bouchage.\nUtilisez la poubelle.' } },
      { icon: '💧', title: { es: 'Agua', en: 'Water', fr: 'Eau' }, content: { es: 'El departamento tiene sistema de agua filtrada.\nHay filtro adicional para refrigerador y máquina de hielo.\n⚠️ Beber agua (incluyendo hielo) es bajo tu propio riesgo.', en: 'The apartment has a whole-apartment water system.\nAdditional filter for refrigerator and ice maker.\n⚠️ Drinking water (including ice) is at your own risk.', fr: 'L\'appartement a un système de filtration d\'eau.\nFiltre supplémentaire pour réfrigérateur et machine à glace.\n⚠️ Boire l\'eau (y compris la glace) est à vos risques.' } },
      { icon: '🏥', title: { es: 'Emergencias', en: 'Emergencies', fr: 'Urgences' }, content: { es: 'Emergencias: 911\nCruz Roja: 322-222-1533\nHospital CMQ: 322-223-1919\nFarmacia Guadalajara: 322-224-1100', en: 'Emergencies: 911\nRed Cross: 322-222-1533\nCMQ Hospital: 322-223-1919\nPharmacia Guadalajara: 322-224-1100', fr: 'Urgences: 911\nCroix-Rouge: 322-222-1533\nHôpital CMQ: 322-223-1919\nPharmacie Guadalajara: 322-224-1100' } },
      { icon: '📞', title: { es: 'Contacto Castle Solutions', en: 'Contact Castle Solutions', fr: 'Contact Castle Solutions' }, content: { es: '📱 Host: Claudia Castillo\n📞 WhatsApp: +52 322 306 8482\n\n¡Estamos para ayudarte!', en: '📱 Host: Claudia Castillo\n📞 WhatsApp: +52 322 306 8482\n\nWe\'re happy to help!', fr: '📱 Hôte: Claudia Castillo\n📞 WhatsApp: +52 322 306 8482\n\nNous sommes là pour vous aider!' } },
    ]
  },
  'mismaloya-5705': {
    name: 'La Jolla de Mismaloya 5705',
    sections: [
  ...
  'cielo-101': {
    name: 'El Cielo 101',
    sections: [
      { icon: '📶', title: { es: 'WiFi', en: 'WiFi', fr: 'WiFi' }, content: { es: 'Red: HUAWEI-eF84\nContraseña: Cielo101.2', en: 'Network: HUAWEI-eF84\nPassword: Cielo101.2', fr: 'Réseau: HUAWEI-eF84\nMot de passe: Cielo101.2' } },
      { icon: '🔐', title: { es: 'Acceso al Departamento', en: 'Apartment Access', fr: 'Accès à l\'Appartement' }, content: { es: 'Código de puerta: 7330\n\n⚠️ IMPORTANTE:\n• No hay recepción. Debes agendar hora de encuentro.\n• Sin cita previa, podrías esperar hasta 1 hora o hasta que llegue un cerrajero.\n• Al entrar encontrarás tarjetas blancas — úsalas para abrir el departamento (sin usar el código).\n• Los tokens azules son para el acceso al edificio (NO para el departamento).\n• No pierdas ni olvides los tokens azules — no hay quien los reponga de inmediato.\n• Pérdida de llaves = cargo de $75 USD.\n• No dejes el seguro puesto al salir (bloquea códigos y tarjetas).', en: 'Door code: 7330\n\n⚠️ IMPORTANT:\n• No front desk. You must schedule a meeting time.\n• Without an appointment, you may wait up to 1 hour or until a locksmith arrives.\n• Inside you\'ll find white cards — use them to open the apartment (no code needed).\n• Blue tokens are for building access only (NOT for the apartment).\n• Do not lose the blue tokens — replacement is not immediate.\n• Lost keys = $75 USD charge.\n• Don\'t leave the deadbolt engaged when leaving (blocks codes and cards).', fr: 'Code de porte: 7330\n\n⚠️ IMPORTANT:\n• Pas de reception. Vous devez planifier une heure de rencontre.\n• Sans rendez-vous, vous pourriez attendre jusqu a 1 heure ou jusqu a l arrivee d un serrurier.\n• A l interieur, vous trouverez des cartes blanches — utilisez-les pour ouvrir l appartement (sans code).\n• Les jetons bleus sont pour l acces au batiment uniquement (PAS pour l appartement).\n• Ne perdez pas les jetons bleus — le remplacement n est pas immediat.\n• Cles perdues = frais de 75 USD.\n• Ne laissez pas le verrou engage en partant (bloque les codes et les cartes).' } },
